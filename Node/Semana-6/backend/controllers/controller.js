module.exports = {
    ...
    deletaUser: (req, res) => {
        ...
        res.status(200).json([{mensagem:`id ${id} deletado com sucesso.`}, novaLista])
    ...
    verificaIdade: (req, res,) => {
        ...
        if(idade < 21) return res.json({mensagem: 'Usuário não possui idade suficiente'})

        res.status(200).json({mensagem: `usuário ${nome} criado com sucesso`})
    }
}